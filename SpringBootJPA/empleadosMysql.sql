...
INSERT INTO `Authorities` VALUES (6,'ROLE_USER'),(7,'ROLE_ADMIN');
...
CREATE TABLE `authorities_users` (
  ...
  PRIMARY KEY (`authority_id`,`usuarios_id`),
  KEY `fk_Authorities_has_usuarios_usuarios1_idx` (`usuarios_id`),
  KEY `fk_Authorities_has_usuarios_Authorities1_idx` (`authority_id`),
  CONSTRAINT `fk_Authorities_has_usuarios_Authorities1` FOREIGN KEY (`authority_id`) REFERENCES `Authorities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Authorities_has_usuarios_usuarios1` FOREIGN KEY (`usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `authorities_users` VALUES (6,6),(6,7),(7,7);
...
INSERT INTO `hijos` VALUES (1,0,0),(2,1,0),(3,0,1),(4,1,1),(5,2,1),(6,0,3),(7,10,10),(8,60,0),(9,5,6),(10,5,6),(11,5,6),(12,5,6),(13,5,6),(14,5,6),(15,5,6),(16,5,6),(17,5,6),(18,5,6),(19,5,6);
...
INSERT INTO `usuarios` VALUES (6,'user','$2a$04$nOPQU0dZaSpvvjKl63unkO4DsNGiWXQOQTJULJB33fkh9A96K/38G',1),(7,'admin','$2a$04$CDBzJHLbDtwc9imNYWI1wOWVb9GMGt47mjjTvFQYIdCJD0dEa3dRm',1);
...
-- Dump completed on 2021-05-26 10:36:18
